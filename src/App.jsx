...
const App = () => {
  ...
  // Performance Optimization: Removed high-frequency scroll velocity tracker
  // which updated document-level CSS variables on every frame, causing repaint lagging.
